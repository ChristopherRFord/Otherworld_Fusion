 ...
 * 
 * Defines a "virtual resolution" which allows the game to
 * render to a specific resolution no matter of the actual
 * resolution of the device. This allows for one set of assets
 * for all resolutions and devices
 */
public class VirtualViewport
{
	...
	public float getWidth() 		 {	return getWidth(Gdx.graphics.getWidth(), Gdx.graphics.getHeight());		}
	public float getHeight() 		 {	return getHeight(Gdx.graphics.getWidth(), Gdx.graphics.getHeight());	}
